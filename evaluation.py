...
def evaluate(experiment):
    ...
    while k < len(indexes):
        ...
        reward = reward_fn.reward(hyp=pred_seq, ref=YU_tensor, context=[[s for s in X.data.tolist()] for X in XU_tensor], da_context=X_tensor, turn=turn_tensor, step_size=step_size)
